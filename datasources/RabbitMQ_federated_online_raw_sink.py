...
class OnlineFederatedRawSink(RabbitMLSink):
    ...
    def __init__(self, boostrap_servers, topic, deployment_id,
                 data_type=None, label_type=None, description='', dataset_restrictions='{}', data_reshape=None,
                 label_reshape=None, validation_rate=0, control_topic='FEDERATED_DATA_CONTROL_TOPIC',
                 group_id: Datasource = Datasource.ONLINE_RAW_SINK, user='guest', password='guest'):
